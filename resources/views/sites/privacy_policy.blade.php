...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased relative text-center w-full h-screen overflow-x-hidden">
        ...
        <div class="w-screen mt-12 relative flex flex-col justify-center content-center items-center overflow-x-hidden">
            <div class="" style="background: rgba(255, 255, 255, 75%)">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Chatapp.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Chatapp, accessible from <a href="https://czatap.k-langer.pl/" rel="external nofollow noopener" target="_blank">https://czatap.k-langer.pl/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: kamillanger4@gmail.com</li>
                </ul>
            </div>
        </div>
